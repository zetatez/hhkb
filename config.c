...
cfg_default(void) {
  ...
  cfg.cross_window_transparency       = (cfg_item_t){{ .d = 0.618                                                           }, "cross-window-transparency"       };
  cfg.cross_bg_color                  = (cfg_item_t){{ .s = "#4DA3FF"                                                       }, "cross-bg-color"                  };
  ...
  cfg.set_to_cross_mode               = (cfg_item_t){{ .k = {MODKEY|ControlMask, XStringToKeysym("c")                      }}, "set-to-cross-mode"               };
  ...
  cfg.escape_cross                    = (cfg_item_t){{ .k = {NoSymbol          , XStringToKeysym("Escape")                 }}, "escape-cross"                    };
